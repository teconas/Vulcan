...
public static class CountTests
{
    ...
    public class Bounds
    {
        ...
        [Fact]
        public void SecondTakeReducesCount()
        {
            // Arrange

            // Act
            var result = Count.Up(0).Take(5).Take(3).ToArray();
        ...
        [Fact]
        public void SecondTakeCannotIncreaseCount()
        {
            // Arrange

            // Act
            var result = Count.Up(0).Take(3).Take(5).ToArray();
