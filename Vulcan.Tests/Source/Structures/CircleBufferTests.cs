...
public class CircleBufferTests
{
    ...
    [Fact]
    public void CopyTo_DestinationLargerThanNeeded()
    {
        // Arrange
        _sut.AddRange(1, 2, 3, 4, 5);
        var array = new int[5];
    ...
    [Fact]
    public void CopyTo_IndexBeyondArray_EmptyBuffer_Throws()
    {
        // Arrange
        var array = new int[3];

        // Act / Assert
        Should.Throw<ArgumentOutOfRangeException>(() => _sut.CopyTo(array, 4));
    }
